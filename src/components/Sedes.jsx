...
const gymLocations = [
  {
    ...
    description: 'Entrená en la sede de inicio de JOCKEY GYM, con 25 años de trayectoria formando generaciones de atletas y amantes del fitness. Ubicación estratégica en el corazón de la ciudad.',
    schedule: {
...

  {
    ...
    description: 'Entrena en nuestra sede de la Av. Perón y pon a prueba nuestra meta de competir contra el tiempo.',
    schedule: {
      lunesAViernes: '08:00 - 23:00',
      sabados: '09:00 - 13:30 / 16:00 - 20:00'
    },
...

  {
    ...
    description: 'La sede ideal para quienes buscan entrenar en un entorno dinámico y con equipamiento de última generación sobre la Avenida Aconquija.',
    schedule: {
...
const Sedes = () => {
  // Establece la primera sede del arreglo como la seleccionada por defecto
